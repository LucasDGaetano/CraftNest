...
atelier1 = Atelier.new(name: "Au plaisir du petit Paris", category: "Peinture", location: "Paris", price: 300, user: user1)
...
atelier2 = Atelier.new(name: "Au coin du feu", category: "Sculpture", location: "Poitiers", price: 120, user: user2)
...
atelier3 = Atelier.new(name: "Le doux repos", category: "Joaillerie", location: "Lyon", price: 150, user: user3)
...
atelier4 = Atelier.new(name: "Premier mercredi", category: "Bois", location: "Lille", price: 220, user: user4)
...
atelier5 = Atelier.new(name: "Le four", category: "Céramique", location: "Rennes", price: 400, user: user5)
...
atelier6 = Atelier.new(name: "Tu m'as vu", category: "Peinture", location: "Angers", price: 100, user: user6)
...
atelier7 = Atelier.new(name: "Chère enfant", category: "Joaillerie", location: "Compiègne", price: 500, user: user7)
...
atelier8 = Atelier.new(name: "A la joie de Bagnolet", category: "Bois", location: "Bagnolet", price: 600, user: user8)
...
atelier9 = Atelier.new(name: "A côté du marché", category: "Céramique", location: "Reims", price: 200, user: user9)
...
atelier10 = Atelier.new(name: "La bonne chaleur", category: "Céramique", location: "Marseille", price: 340, user: user10)
